...
$flag = $factory->createDatabase()->getReference('Users/'.$user."/Health_Data")->getSnapshot()->exists();
if($flag) {
    $Data = $factory->createDatabase()->getReference('Users/' . $user . "/Health_Data")->getValue();
    $data = [];
    try {

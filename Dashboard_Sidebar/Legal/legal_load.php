...
$flag = $factory->createDatabase()->getReference('Users/'.$user."/Legal_Data")->getSnapshot()->exists();
if($flag) {
    $Data = $factory->createDatabase()->getReference('Users/' . $user . "/Legal_Data")->getValue();
    $data = [];
    try {
